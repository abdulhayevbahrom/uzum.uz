...
function CartProducts() {
  ...
  return (
    <div className="home_cart_products">
      ...
      <h2>Savatingiz, <span>1 mahsulot</span></h2>
      ...
      <div className="cart_product_items">
        ...
        <input type="checkbox" />
        <img src="https://images.uzum.uz/ck61u4kvutv2kev20dn0/t_product_240_high.jpg" alt="/" />
        </div>
        <div className='cart_products_items_sale'>
        <h3>Vertolyot o'yinchog'i bolalar uchun, mini dron, qo'lda boshqarish</h3>
        <p>Sotuvchi: <span>Дети</span></p>
        <p>Rang: <span>Ko'k</span></p>
        </div>
        <div className="cart_products_cart_products_items_count">
                        ...
                        <div className="cart_products_cart_products_items_trash">
                            <a href="/"><FaTrash></FaTrash> <span>Yo'q qilish</span></a>
                            <p>85 000 so'm</p>
                            <s>155 000</s>
                        </div>
      </div>
